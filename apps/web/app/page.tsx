        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:py-20">
          <div>
            ...
            <p className="mt-6 max-w-3xl text-xl leading-9 text-slate-700">
              Выберите задачу, ответьте на несколько вопросов и скачайте готовый DOCX/PDF. Для презентации — PPTX. Первая попытка в каждом модуле бесплатна.
            </p>
      ...
      <Section id="how-it-works" eyebrow="Как работает" title="Короткий путь к рабочему файлу" className="bg-white">
        <div className="grid gap-5 lg:grid-cols-4">
          {[
            ...
            ["4", "Скачайте результат", "DOCX/PDF/PPTX сразу, затем email, кабинет и проект — по желанию."],
          ].map(([step, title, text]) => (
