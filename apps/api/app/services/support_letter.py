...
def _build_support_prompt(payload: NormalizedSupportLetterPayload) -> str:
    ...
    cofinance = "Оценка вклада не указана" if payload.cofinance.formatted == PLACEHOLDER else payload.cofinance.formatted
    return (
        "SYSTEM:\n"
        ...
        f"- Оценка вклада в рублях: {cofinance}\n\n"
        "Требования к блоку:\n"
        ...
        "11. Не добавляй приветствие, подпись, адресата, дату, исходящий номер.\n"
        "12. Весь блок — максимум 900 символов.\n"
        "13. Если информации мало, пиши осторожно и не выдумывай детали.\n\n"
        "Верни только JSON:\n"
        "{\n"
        '  "ai_support_block": "..."\n'
        "}"
