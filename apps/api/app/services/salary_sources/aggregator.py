...
ROLE_SYNONYMS = {
    "координатор": ["ведущий координатор", "координатор проекта", "координатор мероприятий", "администратор проекта", "организатор мероприятий"],
    "организатор": ["организатор мероприятий", "организатор события", "координатор мероприятий", "event manager", "администратор мероприятий"],
    "куратор": ["куратор проекта", "ведущий координатор", "руководитель проекта", "координатор проекта"],
    "режиссер": ["режиссер", "кинорежиссер", "режиссер-постановщик", "художественный руководитель"],
    "администратор": ["администратор проекта", "ведущий координатор", "координатор проекта", "администратор мероприятий"],
    "маркетолог": ["маркетолог", "менеджер по digital-маркетингу", "специалист по digital-маркетингу", "специалист по маркетингу", "менеджер по маркетингу"],
    ...
    "художник": ["художник-постановщик", "дизайнер-декоратор", "сценограф", "художник-сценограф", "художник театра", "художник-декоратор"],
